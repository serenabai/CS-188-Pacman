...
def joinFactors(factors: List[Factor]):
    ...
    new_factor = Factor(uncond, new_cond, domain)
    ...
    for ass in new_factor.getAllPossibleAssignmentDicts():
        ...
        new_factor.setProbability(ass, prob)
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        new_factor = Factor(uncond, cond, domain)

        for ass in new_factor.getAllPossibleAssignmentDicts():
            prob = 0
            for val in domain[eliminationVariable]:
                temp_ass = ass
                temp_ass[eliminationVariable] = val
                prob += factor.getProbability(temp_ass)
            new_factor.setProbability(ass, prob)
